...
const What_do_we_do = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen max-w-[1284px] mx-auto px-4 space-y-10 pt-28 pb-18">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-0 md:gap-x-3 gap-y-3 md:gap-y-0">
          {/* card1 */}
          {what_do_we_do.map((i, index) => (
            <div
              key={index}
              className="h-full w-full flex flex-col items-center corner"
            >
