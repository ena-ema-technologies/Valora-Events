...
const Why_choose_us = () => {
  return (
    <>
      <div className="min-h-screen w-full overflow-hidden py-16 flex items-center justify-between gap-x-4 flex-col md:flex-row">
            ...
            <div>
              {why_choose_us.map((i, index) => (
                ...
                >
                  ...
                  <p className="white-gray-2">{i.point}</p>
                </div>
              ))}
            </div>
          </div>
